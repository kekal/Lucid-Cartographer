...
- **Design-decision comment codes** in source — search the codebase before changing flagged code: `ARCH-CRIT-*`, `ARCH-HIGH-*`, `ARCH-LOW-*`, `HIGH-*`, `MED-*`, `IE-*`, and the Trip slice's `TRIP-*` codes (e.g. `TRIP-CACHE-01`, `TRIP-SCHEMA-01`, `TRIP-TRAVELTIME-01`, `TRIP-OSRM-01`, `TRIP-DEGRADE-01`, `TRIP-MANUAL-01`, the Wave-2 codes `TRIP-LEGMODE-01`, `TRIP-RECONCILE-01`, `TRIP-SCHEDULE-01`, and the bulk-mode code `TRIP-BULKMODE-01`).
